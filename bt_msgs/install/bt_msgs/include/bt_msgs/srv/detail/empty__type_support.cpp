...
{
  new (message_memory) bt_msgs::srv::Empty_Request(_init);
}

void Empty_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<bt_msgs::srv::Empty_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Empty_Request_message_member_array[1] = {
  {
    ...
    offsetof(bt_msgs::srv::Empty_Request, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Empty_Request_message_members = {
  "bt_msgs::srv",  // message namespace
  "Empty_Request",  // message name
  1,  // number of fields
  sizeof(bt_msgs::srv::Empty_Request),
...
get_message_type_support_handle<bt_msgs::srv::Empty_Request>()
{
  return &::bt_msgs::srv::rosidl_typesupport_introspection_cpp::Empty_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bt_msgs, srv, Empty_Request)() {
  return &::bt_msgs::srv::rosidl_typesupport_introspection_cpp::Empty_Request_message_type_support_handle;
}
...
void Empty_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) bt_msgs::srv::Empty_Response(_init);
}

void Empty_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<bt_msgs::srv::Empty_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Empty_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bt_msgs::srv::Empty_Response, structure_needs_at_least_one_member),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Empty_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(bt_msgs::srv::Empty_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<bt_msgs::srv::Empty_Response>()
{
  return &::bt_msgs::srv::rosidl_typesupport_introspection_cpp::Empty_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bt_msgs, srv, Empty_Response)() {
  return &::bt_msgs::srv::rosidl_typesupport_introspection_cpp::Empty_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Empty_service_members = {
  "bt_msgs::srv",  // service namespace
  "Empty",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<bt_msgs::srv::Empty>()
...
get_service_type_support_handle<bt_msgs::srv::Empty>()
{
  // get a handle to the value to be returned
  auto service_type_support =
    &::bt_msgs::srv::rosidl_typesupport_introspection_cpp::Empty_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bt_msgs, srv, Empty)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<bt_msgs::srv::Empty>();
}
