...
static const _Empty_type_support_symbol_names_t _Empty_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bt_msgs, msg, Empty)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bt_msgs, msg, Empty)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bt_msgs, msg, Empty)() {
  return &::bt_msgs::msg::rosidl_typesupport_c::Empty_message_type_support_handle;
}
