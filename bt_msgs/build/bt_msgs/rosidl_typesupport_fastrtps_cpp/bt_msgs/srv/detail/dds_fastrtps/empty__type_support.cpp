...
#include "bt_msgs/srv/detail/empty__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const bt_msgs::srv::Empty_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  bt_msgs::srv::Empty_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const bt_msgs::srv::Empty_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<bt_msgs::srv::Empty_Request *>(
    untyped_ros_message);
...
{
  return &bt_msgs::srv::typesupport_fastrtps_cpp::_Empty_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bt_msgs, srv, Empty_Request)() {
  return &bt_msgs::srv::typesupport_fastrtps_cpp::_Empty_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_bt_msgs
cdr_serialize(
  const bt_msgs::srv::Empty_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: structure_needs_at_least_one_member
  cdr << ros_message.structure_needs_at_least_one_member;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  bt_msgs::srv::Empty_Response & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const bt_msgs::srv::Empty_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<bt_msgs::srv::Empty_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &bt_msgs::srv::typesupport_fastrtps_cpp::_Empty_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bt_msgs, srv, Empty_Response)() {
  return &bt_msgs::srv::typesupport_fastrtps_cpp::_Empty_Response__handle;
}
...
{
  return &bt_msgs::srv::typesupport_fastrtps_cpp::_Empty__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bt_msgs, srv, Empty)() {
  return &bt_msgs::srv::typesupport_fastrtps_cpp::_Empty__handle;
}
