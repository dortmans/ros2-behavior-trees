...
#include "bt_msgs/msg/detail/empty__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const bt_msgs::msg::Empty *>(
    untyped_ros_message);
...
{
  return &bt_msgs::msg::typesupport_fastrtps_cpp::_Empty__handle;
}
