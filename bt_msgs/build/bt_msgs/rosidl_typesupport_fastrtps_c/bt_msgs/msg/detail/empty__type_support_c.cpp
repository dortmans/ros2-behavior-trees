...
#include "bt_msgs/msg/detail/empty__rosidl_typesupport_fastrtps_c.h"
...
using _Empty__ros_msg_type = bt_msgs__msg__Empty;
...
size_t get_serialized_size_bt_msgs__msg__Empty(
  const void * untyped_ros_message,
...
static uint32_t _Empty__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_bt_msgs__msg__Empty(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_bt_msgs
size_t max_serialized_size_bt_msgs__msg__Empty(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_bt_msgs__msg__Empty(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bt_msgs, msg, Empty)() {
