...
#include "bt_msgs/srv/detail/empty__rosidl_typesupport_fastrtps_c.h"
...
using _Empty_Request__ros_msg_type = bt_msgs__srv__Empty_Request;
...
size_t get_serialized_size_bt_msgs__srv__Empty_Request(
  const void * untyped_ros_message,
...
static uint32_t _Empty_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_bt_msgs__srv__Empty_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_bt_msgs
size_t max_serialized_size_bt_msgs__srv__Empty_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_bt_msgs__srv__Empty_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bt_msgs, srv, Empty_Request)() {
...
using _Empty_Response__ros_msg_type = bt_msgs__srv__Empty_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_bt_msgs
size_t get_serialized_size_bt_msgs__srv__Empty_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Empty_Response__ros_msg_type * ros_message = static_cast<const _Empty_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_bt_msgs__srv__Empty_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_bt_msgs
size_t max_serialized_size_bt_msgs__srv__Empty_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_bt_msgs__srv__Empty_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bt_msgs, srv, Empty_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bt_msgs, srv, Empty)() {
