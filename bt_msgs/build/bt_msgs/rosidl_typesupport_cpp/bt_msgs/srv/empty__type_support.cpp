...
static const _Empty_Request_type_support_symbol_names_t _Empty_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bt_msgs, srv, Empty_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bt_msgs, srv, Empty_Request)),
  }
};
...
{
  return &::bt_msgs::srv::rosidl_typesupport_cpp::Empty_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, bt_msgs, srv, Empty_Request)() {
  return get_message_type_support_handle<bt_msgs::srv::Empty_Request>();
}
...
static const _Empty_Response_type_support_symbol_names_t _Empty_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bt_msgs, srv, Empty_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bt_msgs, srv, Empty_Response)),
  }
};
...
{
  return &::bt_msgs::srv::rosidl_typesupport_cpp::Empty_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, bt_msgs, srv, Empty_Response)() {
  return get_message_type_support_handle<bt_msgs::srv::Empty_Response>();
}
...
static const _Empty_type_support_symbol_names_t _Empty_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bt_msgs, srv, Empty)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bt_msgs, srv, Empty)),
  }
};
...
{
  return &::bt_msgs::srv::rosidl_typesupport_cpp::Empty_service_type_support_handle;
}
