...
static const _Empty_type_support_symbol_names_t _Empty_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bt_msgs, msg, Empty)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bt_msgs, msg, Empty)),
  }
};
...
get_message_type_support_handle<bt_msgs::msg::Empty>()
{
  return &::bt_msgs::msg::rosidl_typesupport_cpp::Empty_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, bt_msgs, msg, Empty)() {
  return get_message_type_support_handle<bt_msgs::msg::Empty>();
}
