...
#include <stddef.h>
#include "bt_msgs/srv/detail/empty__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember Empty_Request__rosidl_typesupport_introspection_c__Empty_Request_message_member_array[1] = {
  {
    ...
    offsetof(bt_msgs__srv__Empty_Request, structure_needs_at_least_one_member),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Empty_Request__rosidl_typesupport_introspection_c__Empty_Request_message_members = {
  "bt_msgs__srv",  // message namespace
  "Empty_Request",  // message name
  1,  // number of fields
  sizeof(bt_msgs__srv__Empty_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bt_msgs, srv, Empty_Request)() {
...
static rosidl_typesupport_introspection_c__MessageMember Empty_Response__rosidl_typesupport_introspection_c__Empty_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bt_msgs__srv__Empty_Response, structure_needs_at_least_one_member),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Empty_Response__rosidl_typesupport_introspection_c__Empty_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(bt_msgs__srv__Empty_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_bt_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bt_msgs, srv, Empty_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers bt_msgs__srv__detail__empty__rosidl_typesupport_introspection_c__Empty_service_members = {
  "bt_msgs__srv",  // service namespace
  "Empty",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // bt_msgs__srv__detail__empty__rosidl_typesupport_introspection_c__Empty_Request_message_type_support_handle,
  NULL  // response message
  // bt_msgs__srv__detail__empty__rosidl_typesupport_introspection_c__Empty_Response_message_type_support_handle
};

static rosidl_service_type_support_t bt_msgs__srv__detail__empty__rosidl_typesupport_introspection_c__Empty_service_type_support_handle = {
  0,
  &bt_msgs__srv__detail__empty__rosidl_typesupport_introspection_c__Empty_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bt_msgs, srv, Empty)() {
  if (!bt_msgs__srv__detail__empty__rosidl_typesupport_introspection_c__Empty_service_type_support_handle.typesupport_identifier) {
    bt_msgs__srv__detail__empty__rosidl_typesupport_introspection_c__Empty_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)bt_msgs__srv__detail__empty__rosidl_typesupport_introspection_c__Empty_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bt_msgs, srv, Empty_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bt_msgs, srv, Empty_Response)()->data;
  }

  return &bt_msgs__srv__detail__empty__rosidl_typesupport_introspection_c__Empty_service_type_support_handle;
}
